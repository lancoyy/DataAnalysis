...
public class DaoUtil {
	 ...
	 */
	public static String[] getClassTableColumnName(Class clazz)
	 ...
	 * @throws IntrospectionException
	 */
	public static String[] getBeanTableColumnNames(final Object object)
			throws IntrospectionException {
		Class clazz = object.getClass();
	 ...
	 * @return Query
	 */
	public static Query createConditionQuery(SessionFactory sessionFactory,
			StringBuffer stringBuffer, final String[] propertyNames,
			final Object[] values, final String sortColumn, final boolean isAsc) {
		// 生成带参数的HQL
		DaoUtil.fillParameters(stringBuffer, propertyNames);
		// 排序
		String desc = isAsc ? "asc" : "desc";
		stringBuffer.append("order by obj.").append(sortColumn)
				.append(" " + desc);
		// 填充实参
		Query query = DaoUtil.fillValues(sessionFactory, stringBuffer,
	 ...
	 * 
	 * @param stringBuffer
	 *            obj where之前语句生成的stringBuffer
	 * @param propertyNames
	 *            属性名称数组
	 * @return StringBuffer
	 */
	public static StringBuffer fillParameters(final StringBuffer stringBuffer,
		...
		for (int i = 0; i < propertyNames.length; i++) {
			// 第一个条件
			if (i == 0)
				stringBuffer.append("obj.").append(propertyNames[i])
						.append("=:").append(propertyNames[i] + " ");
			// 第二个开始的条件
			if (i != 0)
				stringBuffer.append("and obj.").append(propertyNames[i])
						.append("=:").append(propertyNames[i] + " ");
		}
		// 生成查询语句
	 ...
	 * @return Query
	 */
	public static Query fillValues(SessionFactory sessionFactory,
			final StringBuffer stringBuffer, final String[] propertyNames,
			final Object[] values) {
	 ...
	 * @return Query
	 */
	public static Query createSingleConditionHqlQuery(
			SessionFactory sessionFactory, StringBuffer stringBuffer,
			final String propertyName, final Object value,
			final String sortColumn, final boolean isAsc) {
		// 组装HQL
		String desc = isAsc ? "asc" : "desc";
		stringBuffer.append(" obj where obj.").append(propertyName)
				.append("=:").append(propertyName).append(" order by obj.")
	 ...
	 * @return map
	 */
	public static <T> Map<String, Object> getBeanPropertiesAndValues(
	 ...
	 * 
	 * @param map
	 *            MAP<String propertyName,Object value>
	 ...
	 * @return List
	 */
	public static List<List> assemblingList(final Integer size,
			final Object... obj) {
